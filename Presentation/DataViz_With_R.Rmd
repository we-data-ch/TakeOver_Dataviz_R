...
<!-- add images square next to the name -->
.pull-left[

```{r ,  fig.show='hold'}
url <- "https://wedata.ch/img/team/DMT_pic_square.png"
image_link(url,url,width="100px")


url <- "https://wedata.ch/img/team/vestin.webp"
image_link(url,url,width="100px")
...
- David Munoz Tord: Data Scientist chez WeData
- Vestin Hategekimana: Data Scientist chez WeData
- Iván Lorenci De Francisco: Data Scientist chez WeData
