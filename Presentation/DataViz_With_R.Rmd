...
- Agile data exploration: rapid iteration
- aestetics allow layering of hierarchies of features
- geoms handles a lot so let to get wrong
- dominates traditional graphics for rich datasets

need very little changes
geoms handles a lot for us
---
