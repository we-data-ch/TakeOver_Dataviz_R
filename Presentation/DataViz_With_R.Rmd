...
Pourquoi ne pas plutôt envisager un barplot/lolipop plot ?
...
Quel type de graphique est le plus adapté pour visualiser la corrélation entre les variables d'un dataset ?
-- 
Correlogram 
-- 
...
Scatter plot 
-- 
Reponse : Violin plot / Question: Quel type de graphique est le plus adapté pour comparer visuellement la distribution de deux variables continues avec beaucoup de points (e.g. 
...
--
Reponse: line plot ou area plot
--
- Quel type de graphique est le plus adapté pour visualiser la répartition des ventes de voitures par marque ?
--
Reponse: bar plot

- Quel type de graphique est le plus adapté pour visualiser la répartition des ventes de voitures par marque et par année ?
- Reponse: stacked bar plot

- Quel type de graphique est le plus adapté pour visualiser les relations entre les pays de l'UE ?
- Reponse: graph diagram

- Quel type de graphique est le plus adapté pour visualiser les relations entre les pays de l'UE et les flux de migrants entre ces pays ?
- Reponse: Sankey diagram

- Quel type de graphique est le plus adapté pour visualiser le
